...
<style scoped>
  ...
  .default-primary-color-text { color: #212121; } 
  .light-primary-color   { background: #9E9E9E; } 
  .light-primary-color-text   { color: #9E9E9E; } 
  .accent-color-text          { color: #212121; } 
  .accent-color          { background: #212121; } 
  .accent-light          { background: #FF9100; } 
  .accent-light-text          { color: #FF9100; } 
  .accent-tint           { background: #FF8A33; } 
  .accent-tint-text           { color: #FF8A33; } 
